...
Component.options.__file = "D:\\vue\\timeline_backend\\src\\views\\timeline\\index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ec01c06a", Component.options)
  } else {
    hotAPI.reload("data-v-ec01c06a", Component.options)
  }
})()}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__api_index__ = __webpack_require__(52);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    getTimelineDetail: function getTimelineDetail(id) {
      var that = this;
      __WEBPACK_IMPORTED_MODULE_0__api_index__["a" /* default */].getTimelineDetail({
        data: {
          id: id
        },
    ...
    getTimelineList: function getTimelineList() {
      var that = this;
      __WEBPACK_IMPORTED_MODULE_0__api_index__["a" /* default */].getTimelineList({
        data: {
...
ajax.getTimelineList = function (obj) {
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://sone.timeline.hellobirds.top/time_line/getTimeLineList', {
    params: obj.data
  }).then(function (res) {
    if (res.data.code === 0) {
...
ajax.getTimelineDetail = function (obj) {
  __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('http://sone.timeline.hellobirds.top/time_line/getTimeLineDetail', {
    params: obj.data
  }).then(function (res) {
    if (res.data.code === 0) {
      obj.success(res.data.data);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-ec01c06a", module.exports)
  }
}
